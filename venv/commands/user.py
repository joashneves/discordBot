...
class User:
    ...
    with open('json/dados_User.json', 'r') as dados:
        try:
            dados_User = json.load(dados)
    ...
    def __init__(self, user_id, bomDia, boaNoite, mensagens, comandos, capturados, xp, level):
        ...
        self.salvar_dados(user_id, bomDia, boaNoite, mensagens, comandos, capturados, xp, level)
    ...
    @classmethod
    def salvar_dados(self, userID, bomDia, boaNoite, mensagens, comandos, capturados, xp, level):
        dados_User[userID] = [bomDia, boaNoite, mensagens, comandos, capturados, xp, level]
        print(dados_User)
        with open('json/dados_user.json', 'w') as dados:
            json.dump(dados_User, dados)
